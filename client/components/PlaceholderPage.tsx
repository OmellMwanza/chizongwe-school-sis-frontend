    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <Card className="text-center">
        <CardContent className="py-16">
          <div className="mb-8">
            {icon || (
              <Construction className="h-16 w-16 text-school-blue mx-auto mb-4" />
            )}
            <h1 className="text-3xl font-bold text-school-blue mb-4">
              {title}
            </h1>
          ...
          <div className="space-y-4">
            <p className="text-school-gray-dark">
              ...
              bring you amazing content and features. Please check back soon!
            </p>
