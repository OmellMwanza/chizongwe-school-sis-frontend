            ...
            <motion.div variants={fadeInUp}>
              <Card className="h-full border-0 shadow-sm hover:shadow-md transition-shadow duration-300">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    To be a leading academic institution recognized for nurturing disciplined, 
                    innovative, and globally competitive students.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="h-full border-0 shadow-sm hover:shadow-md transition-shadow duration-300 bg-gradient-to-br from-school-blue/5 to-school-blue-light/5">
                <CardContent className="p-8 text-center">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">Our Motto</h2>
                  <p className="text-2xl font-bold text-school-blue" style={{ fontFamily: 'serif' }}>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={fadeInUp} className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Our Learning Environment</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Modern facilities designed to foster academic excellence and personal growth.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div variants={fadeInUp}>
              <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 group">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">Engaged learning and collaborative activities</p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 group">
                ...
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Modern Classrooms</h3>
                  <p className="text-gray-600">Interactive learning spaces with modern technology</p>
                </CardContent>
              </Card>
            </motion.div>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 group">
                ...
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Science Laboratories</h3>
